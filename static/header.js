...
Header.main = function() {
	Header.choseAndAnimateHeaderImage();
};
Header.choseAndAnimateHeaderImage = function() {
	...
	Header.HEADER_IMAGE.src = Header.IMAGE_PATHS[Math.floor(Math.random() * Header.IMAGE_PATHS.length)];
};
Header.getImageRealHeight = function(img) {
...
Header.IMAGE_PATHS = ["/content/games/erebus/screenshots/01.jpg","/content/games/erebus/screenshots/02.jpg","/content/games/erebus/screenshots/03.jpg"];
